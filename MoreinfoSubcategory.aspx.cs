...
{
    public partial class MoreinfoSubcategory : System.Web.UI.Page
    {
...
Request.ApplicationPath + "Login.aspx';", true);
        ...
        {
            String query = "SELECT S.scatID AS Subcategory_ID, S.name AS Name  FROM SubCategory S";
            ...
            try
            {
                ...
                if (reader != null && reader.HasRows) //if search results found
                {
                    ...
                    SubCategorySearchGridView.DataSource = dt;  //display found data in grid view
                    SubCategorySearchGridView.DataBind();
