...
{
    public partial class MoreinfoCostcenter : System.Web.UI.Page
    {
...
Request.ApplicationPath + "Login.aspx';", true);
        ...
        protected void viewsubcategory()
        {
            String query = "SELECT CC.costID AS CostCenter_ID, CC.name AS Name  FROM CostCenter CC";
            ...
            try
            {
                ...
                if (reader != null && reader.HasRows) //if search results found
                {
                    ...
                    costcenterSearchGridView.DataSource = dt;  //display found data in grid view
                    costcenterSearchGridView.DataBind();
