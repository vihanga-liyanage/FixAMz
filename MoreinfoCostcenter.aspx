<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoreinfoCostcenter.aspx.cs" Inherits="FixAMz_WebApplication.MoreinfoCostcenter" %>
...
<!--contain-->
            <div  style="min-height: 500px;" class="row">
                ...
                <div class="col-md-4 col-md-offset-2" style="position: relative; padding-left: 0px;">
                    <div class="admin-costcenter-icon hidden-sm hidden-xs" style="margin-top: 60px;"></div>
                </div>
            </div>
<!--Footer-->
